                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-9">
                                <div>
                                    ...
                                    <div class="p-2 mt-5">
                                        <form class="" action="{{route('user.custom.register.submit')}}" method="post">
                                            @csrf

                                            <div class="mb-3 auth-form-group-custom mb-4">
                                                <i class="ri-user-2-line auti-custom-input-icon"></i>
                                                <label for="username">Ref ID</label>
                                                <input type="text" name="have_ref_id" class="form-control" id="username" placeholder="Enter Ref ID">
                                            </div>
                                            <div class="mb-3 auth-form-group-custom mb-4">
                                                <i class="ri-user-2-line auti-custom-input-icon"></i>
                                            ...
                                            <div class="mb-3 auth-form-group-custom mb-4">
                                                ...
                                                <input type="tel" name="phone_number" class="form-control" id="username" placeholder="Enter Phone Number">
                                            </div>
                                            ...
                                            <div class="mb-3 auth-form-group-custom mb-4">
                                                ...
                                                <input type="password" name="confirm_password" class="form-control" id="userpassword" placeholder="Enter Confirm password">
                                            </div>
